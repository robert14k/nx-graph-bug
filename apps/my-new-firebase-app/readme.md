...
* `nx g @simondotm/nx-firebase:function my-function --firebaseApp my-new-firebase-app` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

* `nx run my-new-firebase-app:deploy` - Deploy this app to firebase
* `nx run my-new-firebase-app:serve` - Serve this app using the firebase emulator
* `nx run my-new-firebase-app:build` - Build all functions associated with this app
* `nx run my-new-firebase-app:test` - Test all functions associated with this app
* `nx run my-new-firebase-app:lint` - Lint all functions associated with this app
